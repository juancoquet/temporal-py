...
GHCR is the example target; configure the deployment platform's registry in the publishing workflow.
Published images include the standard OCI source label linking them to their repository.
